...
detection_results_folder = os.getcwd()
detection_results_file = os.path.join(os.getcwd(), "Detection_Results.csv")
...
def detect():
    ...
    FLAGS.input_path = os.path.join(os.getcwd(), 'Data/Source_Images/Test_Images')
    FLAGS.output = os.path.join(os.getcwd(), 'Data/Source_Images/Test_Image_Detection_Results')
    ...
    FLAGS.model_path = os.path.join(os.getcwd(), "Data", "Model_Weights", "trained_weights_final.h5")
    FLAGS.classes_path = os.path.join(os.getcwd(), "Data", "Model_Weights", "data_classes.txt")
